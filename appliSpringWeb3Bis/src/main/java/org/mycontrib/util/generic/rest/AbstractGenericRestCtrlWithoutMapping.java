...
public abstract class AbstractGenericRestCtrlWithoutMapping<ID,DTO extends WithId> {
	...
	public DTO internalGetDtoById(ID id , Integer detailLevel) throws NotFoundException {
		Class<?> dtoClass = DtoByLevelUtil.INSTANCE.getDtoSubClassByLevel(mainDtoClass, detailLevel);
